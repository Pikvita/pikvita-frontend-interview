...
const Header: React.FC = () => {
  ...
  return (
    <header>
      <nav className="bg-[#a6ffff] border-gray-200 px-4 lg:px-6 py-2.5">
        <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
          <Link to="#" className="flex items-center">
            <img
              src="https://www.pikvita.com/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fpikvita-logo.508e589a.png&w=96&q=75"
              className="mr-3 h-6 sm:h-9"
              alt="Pikvita Logo"
            />
            <span className="self-center text-primary-700 text-2xl font-semibold whitespace-nowrap">
              Pikvita
            </span>
          </Link>
